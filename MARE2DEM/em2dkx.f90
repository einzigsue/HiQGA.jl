...
!
    ...
    integer         ::  i,esite, e, n(3), iTx, iparamnum(4), iRx 
    ...
    do iRx = 1,nRx
        ...
        do e = 1, mesh%nele
            ...
            do iComp = 1,nComponents
                ...
                ! if element contains the source, add on delta function:
                if (e==esite) then
...
! 
    ...
    if (sType == 'cs') then
        ...
        case ('intelmkl')
            call intelmkl_zfree(intelmkl_p_E)   
            call intelmkl_zfree(intelmkl_p_H)  
        end select 
